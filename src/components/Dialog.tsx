"use client";
import {formActionDelete} from "@/app/api/serverActions";
...
export default function Dialog({title, children, commentId, onClose} : Props){
    async function handleDelete() {
        await formActionDelete(commentId);
        onClose();
    }
