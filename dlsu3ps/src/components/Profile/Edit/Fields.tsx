export default function Fields({username, email, bio, favoriteCatto, profileImageUrl} : {username: string, email: string, bio: string, favoriteCatto: string, profileImageUrl: string}) {
